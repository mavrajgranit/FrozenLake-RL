...
plt.plot(rewards)
plt.title("Reward")
#plt.savefig('./Plots/QLearning/8x8det/reward.png',bbox_inches='tight')
plt.figure(1)
plt.plot(rewardmeans,color="orange")
plt.title("Mean Reward")
#plt.savefig('./Plots/QLearning/8x8det/meanreward.png',bbox_inches='tight')
plt.figure(2)
plt.plot(qvalues,color="red")
plt.title("Mean Q-Value")
#plt.savefig('./Plots/QLearning/8x8det/meanqvalue.png',bbox_inches='tight')
plt.show()