...
plt.plot(rewards)
plt.title("Reward")
#plt.savefig('./Plots/QTables/4x4det/reward.png',bbox_inches='tight')
plt.figure(1)
plt.plot(scoremeans,color="orange")
plt.title("Mean Reward")
#plt.savefig('./Plots/QTables/4x4det/meanreward.png',bbox_inches='tight')
plt.figure(2)
plt.plot(qvalues,color="red")
plt.title("Mean Q-Value")
#plt.savefig('./Plots/QTables/4x4det/meanqvalue.png',bbox_inches='tight')
plt.show()